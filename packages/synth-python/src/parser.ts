 ...
 * Uses tree-sitter-python for parsing, then converts to Synth format
 */
...
export class PythonParser {
   ...
   */
  parse(source: string, options: PythonParseOptions = {}): Tree {
...
export function parse(source: string, options?: PythonParseOptions): Tree {
