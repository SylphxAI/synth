 ...
 * @returns {Uint8Array}
 */
export function parseBinary(markdown) {
    const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parseBinary(ptr0, len0);
 ...
 * @returns {number}
 */
export function parseCount(markdown) {
    const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parseCount(ptr0, len0);
    return ret >>> 0;
}
...
export class Position {
     ...
     */
    get offset() {
        const ret = wasm.__wbg_get_position_offset(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * Byte offset from start of source
     ...
     */
    set offset(arg0) {
        wasm.__wbg_set_position_offset(this.__wbg_ptr, arg0);
    }
    /**
     * @param {number} line
     * @param {number} column
    ...
    constructor(line, column, offset) {
        const ret = wasm.position_new(line, column, offset);
...
export class Tree {
    ...
    static __wrap(ptr) {
        ...
        obj.__wbg_ptr = ptr;
        TreeFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
     ...
     */
    get node_count() {
        const ret = wasm.tree_node_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    constructor(language, source) {
        ...
        const ret = wasm.tree_new(ptr0, len0, ptr1, len1);
        this.__wbg_ptr = ret >>> 0;
        TreeFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * Get the source
    ...
    get source() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.tree_source(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get root_id() {
        const ret = wasm.tree_root_id(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    toJSON() {
        const ret = wasm.tree_toJSON(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    get language() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.tree_language(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    static fromJSON(json) {
        const ret = wasm.tree_fromJSON(json);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Tree.__wrap(ret[0]);
...
if (Symbol.dispose) Tree.prototype[Symbol.dispose] = Tree.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('synth_wasm_md_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
