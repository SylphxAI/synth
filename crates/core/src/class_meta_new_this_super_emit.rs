...
//!
//! New AST emit skeletons **not** covered by prior residual modules continue71–119:
...
//! continue55 class/meta/new/this/super bases. Full engines remain product residual.
