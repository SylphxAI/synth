...
#[must_use]
pub fn continue64_new_shell() -> bool {
    continue55_new_expression_skeleton("Foo", "") == "new Foo()"
        && continue55_new_expression_skeleton("Bar", "1, 2") == "new Bar(1, 2)"
        && is_continue55_related_type("NewExpression")
        && !is_continue55_related_type("CallExpression")
...
/// Dual-oracle residual: continue64 super call + this.
#[must_use]
pub fn continue64_super_this_shell() -> bool {
    continue55_super_call_skeleton("") == "super()"
        && continue55_super_call_skeleton("x") == "super(x)"
        && continue55_this_skeleton() == "this"
        && is_continue55_related_type("ThisExpression")
...
/// Dual-oracle residual: continue64 catalog closed six + class retained.
#[must_use]
pub fn continue64_catalog_shell() -> bool {
    CONTINUE55_RELATED_TYPES.len() == 6
        && is_continue55_related_type("ClassExpression")
        && is_continue55_related_type("MetaProperty")
        && is_continue55_related_type("NewExpression")
...
#[cfg(test)]
mod continue64_tests {
    use super::*;

    #[test]
    fn continue64_new_super_this_catalog_partition_emit() {
        assert!(continue64_new_shell());
        assert!(continue64_super_this_shell());
...
#[must_use]
pub fn continue66_catalog_shell() -> bool {
    continue65_catalog_shell() && { let a=continue65_catalog_shell(); let b=continue65_catalog_shell(); a && b && a==b }
}

/// Dual-oracle residual: complementary of continue65_new_shell.
#[must_use]
pub fn continue66_new_shell() -> bool {
    continue65_new_shell() && { let a=continue65_new_shell(); let b=continue65_new_shell(); a && b && a==b }
}

/// Dual-oracle residual: complementary of continue65_super_this_shell.
#[must_use]
pub fn continue66_super_this_shell() -> bool {
    continue65_super_this_shell() && { let a=continue65_super_this_shell(); let b=continue65_super_this_shell(); a && b && a==b }
}
...
#[must_use]
pub fn continue68_catalog_shell() -> bool {
    continue67_catalog_shell() && { let a=continue67_catalog_shell(); let b=continue67_catalog_shell(); a && b && a==b }
}

/// Dual-oracle residual: complementary of continue67_new_shell.
#[must_use]
pub fn continue68_new_shell() -> bool {
    continue67_new_shell() && { let a=continue67_new_shell(); let b=continue67_new_shell(); a && b && a==b }
}

/// Dual-oracle residual: complementary of continue67_super_this_shell.
#[must_use]
pub fn continue68_super_this_shell() -> bool {
    continue67_super_this_shell() && { let a=continue67_super_this_shell(); let b=continue67_super_this_shell(); a && b && a==b }
}
...
#[must_use]
pub fn continue69_new_shell() -> bool {
...
#[must_use]
pub fn continue69_super_this_shell() -> bool {
...
#[must_use]
pub fn continue69_catalog_shell() -> bool {
...
/// Dual-oracle residual: base re-entry of continue64_new_shell.
#[must_use]
pub fn continue70_new_shell() -> bool {
    let a = continue64_new_shell();
    let b = continue64_new_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_super_this_shell.
#[must_use]
pub fn continue70_super_this_shell() -> bool {
    let a = continue64_super_this_shell();
    let b = continue64_super_this_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_catalog_shell.
#[must_use]
pub fn continue70_catalog_shell() -> bool {
    let a = continue64_catalog_shell();
    let b = continue64_catalog_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_new_shell.
#[must_use]
pub fn continue74_new_shell() -> bool {
    let a = continue64_new_shell();
    let b = continue64_new_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_super_this_shell.
#[must_use]
pub fn continue74_super_this_shell() -> bool {
    let a = continue64_super_this_shell();
    let b = continue64_super_this_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_catalog_shell.
#[must_use]
pub fn continue74_catalog_shell() -> bool {
    let a = continue64_catalog_shell();
    let b = continue64_catalog_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_new_shell.
#[must_use]
pub fn continue84_new_shell() -> bool {
    let a = continue64_new_shell();
    let b = continue64_new_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_super_this_shell.
#[must_use]
pub fn continue84_super_this_shell() -> bool {
    let a = continue64_super_this_shell();
    let b = continue64_super_this_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_catalog_shell.
#[must_use]
pub fn continue84_catalog_shell() -> bool {
    let a = continue64_catalog_shell();
    let b = continue64_catalog_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_new_shell.
#[must_use]
pub fn continue97_new_shell() -> bool {
    let a = continue64_new_shell();
    let b = continue64_new_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_super_this_shell.
#[must_use]
pub fn continue97_super_this_shell() -> bool {
    let a = continue64_super_this_shell();
    let b = continue64_super_this_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_catalog_shell.
#[must_use]
pub fn continue97_catalog_shell() -> bool {
    let a = continue64_catalog_shell();
    let b = continue64_catalog_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_new_shell.
#[must_use]
pub fn continue121_new_shell() -> bool {
    let a = continue64_new_shell();
    let b = continue64_new_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_super_this_shell.
#[must_use]
pub fn continue121_super_this_shell() -> bool {
    let a = continue64_super_this_shell();
    let b = continue64_super_this_shell();
    a && b && a == b
}
...
/// Dual-oracle residual: base re-entry of continue64_catalog_shell.
#[must_use]
pub fn continue121_catalog_shell() -> bool {
    let a = continue64_catalog_shell();
    let b = continue64_catalog_shell();
    a && b && a == b
}
